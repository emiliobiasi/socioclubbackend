...
ALTER TABLE Follow ADD CONSTRAINT FK_Follow_1 FOREIGN KEY (fk_Client_id) REFERENCES Client (id) ON DELETE RESTRICT;

ALTER TABLE Follow ADD CONSTRAINT FK_Follow_2 FOREIGN KEY (fk_Club_id) REFERENCES Club (id) ON DELETE RESTRICT;
...
VALUES
('Camisa Oficial - Jogo', 'Camisa Oficial de jogo do São Paulo', 300, 1, 1);
