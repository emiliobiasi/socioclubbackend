...
generate_random_value() {
    case $1 in
        ...
        "name")
            ...
            ;;
        "event_name")
            local names=("São Paulo vs. Palmeiras" "São Paulo vs. Corinthians" "São Paulo vs. Santos" "São Paulo vs. Flamengo" "São Paulo vs. Fluminense" "São Paulo vs. Grêmio" "São Paulo vs. Internacional" "São Paulo vs. Atlético Mineiro" "São Paulo vs. Cruzeiro" "São Paulo vs. Bahia")
            printf "'%s'" "${names[RANDOM % ${#names[@]}]}"
            ;;
        "email")
        ...
        "address")
            ...
            ;;
        "fk_club_id"|"fk_client_id"|"fk_clubcategory_id")
