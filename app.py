...
from routers import ClientRouter, AuthRouter, ClubRouter, NewsRouter, ClubCategoryRouter, ProductRouter, PlanRouter, GameRouter
...
app.include_router(GameRouter.router)
